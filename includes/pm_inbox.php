...
if(isset($_POST['deleteBtn'])){
	foreach ($_POST as $key => $value) {
		...
		if ($key != "deleteBtn") {
			$sql = mysqli_query("UPDATE private_messages SET recipientDelete='1', opened='1', WHERE id='$value' AND to_id='$my_id' LIMIT 1");
		}
	}
	...
	<tr>
        ...
        <table width="96%" border="0" align="center" cellpadding="4">
          ...
          <div class="hiddenDiv"><br/>
            ...
            <br/><br/><a href="javascript:toggleReplyBox('<?php echo stripslashes($row['subject']);?>','<?php echo $my_id;?>','<?php echo $Sname;?>','<?php echo $fr_id;?>','<?php echo $thisRandNum;?>')">REPLY</a><br/>
          </div>
        </td>
